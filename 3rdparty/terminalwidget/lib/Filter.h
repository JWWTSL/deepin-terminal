 ...
 */
class TERMINALWIDGET_EXPORT Filter : public QObject
{
public:
    /**
 ...
 * are found.
 */
class TERMINALWIDGET_EXPORT RegExpFilter : public Filter
{
public:
    /**
...
class TERMINALWIDGET_EXPORT UrlFilter : public RegExpFilter
{
    Q_OBJECT
public:
    /**
...
class TERMINALWIDGET_EXPORT FilterObject : public QObject
{
    Q_OBJECT
public:
 ...
 */
class TERMINALWIDGET_EXPORT FilterChain : protected QList<Filter *>
{
public:
    virtual ~FilterChain();
...
class TERMINALWIDGET_EXPORT TerminalImageFilterChain : public FilterChain
{
public:
